...
const EditStyleguide = ({ isVisible, closeModal, handleSearchChange, handleSearchSubmit, searchTerm }) => {
        ...
        <div className={`modal-section ${isVisible ? 'show-modal' : ''}`}>
          <div ref={modalRef} className="modal-container">
            <div className="modal-item">
              ...
              <p>Styleguide Logo</p>
              <div className="general-card small pb-20">
                ...
                <form onSubmit={handleSearchSubmit}>
                  <div className="search-body pt-20">
                  ...
                  <div className="flex-center flex-end btn pt-20">
                    <div className="default-btn main-btn reset">
                      <div className="btn-link">
                        ...
                        >
                          <span className="inner-btn-text">Delete Styleguide</span>
                        </button>
                      </div>
                    </div>
